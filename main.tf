...
resource "azurerm_linux_web_app" "web" {
  ...
  app_settings = {
    ...
    "AZURE_CLIENT_SECRET"                   = "@Microsoft.KeyVault(SecretUri=https://infoasst-kv-geprk.vault.azure.net/secrets/AZURE-CLIENT-SECRET)"
    "AZURE_KEY_VAULT_ENDPOINT"              = "https://infoasst-kv-geprk.vault.azure.net/"
    ...
    "AZURE_OPENAI_SERVICE_KEY"              = "@Microsoft.KeyVault(SecretUri=https://infoasst-kv-geprk.vault.azure.net/secrets/AZURE-OPENAI-SERVICE-KEY)"
...
resource "azurerm_linux_function_app" "example" {
  ...
  app_settings = {
    ...
    "AZURE_FORM_RECOGNIZER_KEY"                  = "@Microsoft.KeyVault(SecretUri=https://infoasst-kv-geprk.vault.azure.net/secrets/AZURE-FORM-RECOGNIZER-KEY)"
    "AZURE_SEARCH_INDEX"                         = "vector-index"
    "AZURE_SEARCH_SERVICE_ENDPOINT"              = "https://infoasst-search-geprk.search.windows.net/"
    "AZURE_SEARCH_SERVICE_KEY"                   = "@Microsoft.KeyVault(SecretUri=https://infoasst-kv-geprk.vault.azure.net/secrets/AZURE-SEARCH-SERVICE-KEY)"
    "BLOB_CONNECTION_STRING"                     = "@Microsoft.KeyVault(SecretUri=https://infoasst-kv-geprk.vault.azure.net/secrets/BLOB-CONNECTION-STRING)"
    ...
    "ENRICHMENT_KEY"                             = "@Microsoft.KeyVault(SecretUri=https://infoasst-kv-geprk.vault.azure.net/secrets/ENRICHMENT-KEY)"
